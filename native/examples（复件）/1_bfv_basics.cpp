...
void example_bfv_basics()
{
    ...
    */
    parms.set_plain_modulus(1048576);
    ...
    */
    ...
    int x7 = 844;
    int x8 = 1224;
    Plaintext x1_plain(to_string(x1));
    Plaintext x2_plain(to_string(x2));
    Plaintext x3_plain(to_string(x3));
    Plaintext x4_plain(to_string(x4));
    Plaintext x5_plain(to_string(x5));
    Plaintext x6_plain(to_string(x6));
    Plaintext x7_plain(to_string(x7));
    Plaintext x8_plain(to_string(x8));
    cout << "Express x = " + to_string(x1) + " as a plaintext polynomial 0x" + x1_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x2) + " as a plaintext polynomial 0x" + x2_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x3) + " as a plaintext polynomial 0x" + x3_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x4) + " as a plaintext polynomial 0x" + x4_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x5) + " as a plaintext polynomial 0x" + x5_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x6) + " as a plaintext polynomial 0x" + x6_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x7) + " as a plaintext polynomial 0x" + x7_plain.to_string() + "." << endl;
    cout << "Express x = " + to_string(x8) + " as a plaintext polynomial 0x" + x8_plain.to_string() + "." << endl;
    ...
    */
    ...
    encryptor.encrypt(x4_plain, x4_encrypted);
    encryptor.encrypt(x5_plain, x5_encrypted);
    encryptor.encrypt(x6_plain, x6_encrypted);
    encryptor.encrypt(x7_plain, x7_encrypted);
 ...
 //   Ciphertext x_sq_plus_one;
    ...
    Ciphertext temp1;
    Ciphertext temp2;
    evaluator.add(x1_encrypted,x2_encrypted,temp1);
    evaluator.add(x3_encrypted,x4_encrypted,temp2);
    evaluator.add(temp1,temp2,avaerge);
    evaluator.add(x5_encrypted,x6_encrypted,temp1);
    evaluator.add(temp1,avaerge,temp2);
    evaluator.add(x7_encrypted,x8_encrypted,temp1);
    evaluator.add(temp2,temp1,avaerge);
...
//        << endl;
    ...
    */
    ...
    decryptor.decrypt(avaerge, decrypted_result);
